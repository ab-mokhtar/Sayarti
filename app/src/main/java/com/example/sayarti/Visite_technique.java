...
public class Visite_technique extends Fragment {
                    ...
                    Objects.requireNonNull(supportMapFragment).getMapAsync(googleMap1 -> {
                        ...
                        if(data.size()>0){
                            for (int i=0;i<data.size();i++){
                                if (data.get(i).getType().equals( "visite" )){
                            ...
                            for (int i=0;i<data2.size();i++){
                                ...
                                markerOptions.icon(bitmapDescriptordescriptor(getContext(),R.drawable.garage));
                                ...
                                googleMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
                                    ...
                                    public View getInfoContents( Marker marker) {
                                        ...
                                        View v = getLayoutInflater().inflate(R.layout.visite_snipette,null);
